export const WebApiRootUrl: string = "http://localhost:6300/api/"; //Core 3.0
//export const WebApiRootUrl: string = "http://localhost:5112/api/"; //Core 2.2
//export const WebApiRootUrl: string = 'http://localhost:20422/api/'; //IIS Express Web API 2.0
//export const WebApiRootUrl: string = "http://localhost/storecoreservice/api/";
